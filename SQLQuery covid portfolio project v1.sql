...
group by LOCATION
order by totalDeathCount DESC
--- CHECKING the column of continent and location for the right excution of the total death count from the coviddeath table
SELECT *
FROM CovidDeaths
...
order by 2,3
--using partition by sum the new vaccination using location
...
-- creating for further later visualization
